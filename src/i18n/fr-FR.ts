...
const frFR: typeof enUS = {
  ...
  common: {
    ...
    deltaE: 'ΔE {{value}}',
    colors: 'Couleurs',
    colorsWithCount: 'Couleurs ({{count}})',
  ...
  palettePanel: {
    title: 'Palette',
    targetColorCount: 'Nombre de couleurs visé',
    targetColorCountAuto: 'Auto ({{count}})',
    targetColorCountReset: 'Revenir à la détection automatique',
  ...
  settingsPage: {
    ...
    inches: 'Pouces',
    symbolStyle: 'Symboles de la grille',
    symbolStyleHelp: 'Choisissez les glyphes utilisés pour marquer chaque couleur de fil dans la grille du patron et la légende.',
    symbolStyleLetters: 'Lettres ({{sample}}…)',
    symbolStyleIcons: 'Formes ({{sample}}…)',
